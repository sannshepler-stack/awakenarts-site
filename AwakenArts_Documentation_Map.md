...
**`AwakenArts_Path_Standard.md`** — *Governing correction. Issued 2026-08-20. Amended three times same day.*
Governs the whole of AwakenArts, not a single Figure or page. Defines the AwakenArts Path as the sequence of stones by which a person moves from encountering symbolic material toward greater capacity to understand the images, language, patterns, and personal myths through which human experience takes shape — and gives the standing three-part test for any element: it must help set a stone, help someone cross one, or give a reason to continue, or it does not belong. **Amended 2026-08-20 ("Laying the Stones")** with the operational definition of a completed crossing: a stone is laid only when Entry State, Foundation, Edition Evidence, Facilitator Movement, Participant Discovery, Why It Matters To You, Exit State, and Next Stone can all be named, with Entry State and Exit State genuinely different. Research alone or activity alone no longer satisfies test item 2. Sharpens a concept the Charter's Addendum A already names ("The Path's role") rather than competing with it. **This document governs the system** — what counts as a stone, a crossing, or an invitation, system-wide. Read this before commissioning or reviewing any page, Figure, workshop stage, or piece of copy.

### 1. Teaching Path Template

**`AwakenArts_Teaching_Path_Development_Brief.md`** — *Governing document. Issued 2026-08-20. Amended three times same day.*
States the homepage premise ("The Language of Symbolic Experience"), the foundational homepage question ("Do we use metaphors so routinely..."), and the Program-level "AwakenArts, A Path of Stones" principle and working movement (IMAGE → LANGUAGE → RECOGNITION → AWARENESS → INTEGRATION → WHOLENESS → CONNECTION, explicitly not yet frozen). Builds Stone One of the Path — "This Human Experience Already Has a Language" — using Robert A. Johnson, William Cullen Bryant, and verified Jung scholarship as the authoritative foundation. Records the nine-part Stone Template as a *development checklist* (not itself the Path — see the Path Standard's Laying-the-Stones correction) every future stone's research must satisfy, reconciled against the eight-part crossing sequence via a mapping table. Establishes, as Edition-level requirements: the Familiar-Language Field (every Edition's own metaphor/idiom research, Dragon's fire/speech field given in full), the First Participant Crossing pattern (familiar metaphor before symbolic interpretation — explicitly not "what does the Dragon mean to you"), the fourteen-step Edition Facilitation Map (working, not frozen), and the three coordinated participant-materials instruments (Presentation, Participant Syllabus, Edition Journal — function established, not produced). Stone One is flagged honestly as checklist-complete but not yet a laid stone (Entry State/Exit State not yet separately named). Deliberately builds only Stone One's content — remaining stones are built one at a time in separate passes, never generated as a complete Path in a single pass. **This document develops and validates individual stones and the Program's overall working movement** — how a stone's content and crossing get built, and how each Edition's own facilitation map should take shape, once the Path Standard has established that it belongs. Read this before writing content for any stone of any Edition's teaching path.

**Governing relationship among the three tiers, stated explicitly per Susan's 2026-08-20 instruction:** `AwakenArts_Path_Standard.md` governs the system — what counts as a stone, a crossing, or an invitation, and when a crossing is complete. `AwakenArts_Teaching_Path_Development_Brief.md` develops and validates the stones — the template and content discipline any stone is built and tested against. Edition-specific documents (Dragon's own governing set, and each Figure's equivalent as it is built) demonstrate how those stones are actually crossed through that Figure's own particular symbolic work. None of the three substitutes for the others.

### 1. Figure Research Method

**`AwakenArts_Figure_Research_and_Development_Standard.md`** — *Governing correction. Issued 2026-08-20.*
Precedes everything below it for any Figure not yet built. AwakenArts no longer treats a Figure's symbolic content as a scaffold for participant reflection prompts — a Figure is researched and understood as a symbolic field (poem, language, cultural/literary association, human pattern) before any workshop content is written. Defines the production sequence every Figure workshop now follows: research the symbol + research the facilitation method → understand the poem/image → establish the workshop purpose → script → visual direction → participant materials → deck → test. **Amended 2026-08-20** with "How the Developmental Movement Is Found, Not Imposed" — AwakenArts does not impose a self-development process on a symbolic work; it works with the movement the material itself reveals (from what lies beyond awareness, toward recognition, understanding, integration, wholeness, and connection). An external framework's stages (VTS, Kolb, a workshop's own prior architecture) may illuminate that movement; they never govern it. Governs Queen Ann and every Figure after it from the start; does not retroactively invalidate Dragon's current governing document or presentation. Read this before beginning any new Figure's workshop development, and before further Dragon workshop content work.
...
## Superseded for Path Architecture (2026-08-20)

Per Susan's "Laying the Stones" governance pass, these documents contain real, usable material and are **not overwritten and not deleted** — but their stage architecture, sequencing claims, or "what constitutes participant movement" assumptions predate and conflict with `AwakenArts_Path_Standard.md`'s Laying-the-Stones correction. Do not treat any document below as authority for workshop sequence, stage design, or slide content. Consult it only as source material, run through `AwakenArts_Teaching_Path_Development_Brief.md`'s current template before anything in it becomes participant-facing again.

| Document | Why superseded for Path architecture | What remains usable |
|---|---|---|
| `AwakenArts_Workbook/Architecture/AwakenArts_Workshop_Presentation_Standard.docx` — *June 2026, previously unregistered in this map.* | States a fixed nine-stage sequence "not adjustable by book — it is the universal framework." This is the direct opposite of the Figure Research Standard's "How the Developmental Movement Is Found, Not Imposed" (2026-08-20): a stage sequence must be revealed by each Figure's own symbolic material, never imposed as a universal template. Its "does this choice protect encounter or replace it?" test is sound and not itself superseded. | The governing test above; the fifteen slide-type discipline as a menu of options, not a fixed sequence; the product-hierarchy and packaging material (Parts Six–Seven), which is a commerce question, not a Path-architecture one. |
| `AwakenArts_Workbook/Book_01_Workshop_System_Blueprint.docx` — *June 2026, previously unregistered in this map.* | Builds its Participant Experience Map directly on the same fixed nine-stage sequence, and treats each stage's own defined activity as constituting participant movement without any Entry State/Exit State discipline. | The product ecosystem and dependency mapping (Part One) remains useful commerce/production reference, separate from the Path-architecture question. |
| `Dragon_Workshop_Blueprint_New_Paradigm.md` — *Goal 3, Pass 1, undated header, work product of an earlier session.* | Dragon-specific paper walkthrough of the (pre-Laying-the-Stones) ten-stage arc; assumes each of its ten stages, once staged, constitutes movement. Status note added in place, 2026-08-20; body not rewritten. | Section 1's inventory of existing, reusable Dragon material (image, poem, Larger Story citation, Reflection questions, Journal page, Name-the-Two/Carry-the-Word practices) remains a valid source list — it simply hasn't been run through the current stone template yet. |

**Not marked superseded, flagged for Susan's own review instead:** `/Users/sashe/Desktop/Dragon Pass One.docx` (the New AwakenArts Paradigm, ten-stage workshop arc) is Susan's own authored strategy document, held outside this repository, and `AWAKENARTS_CURRENT_MATERIALS.md` (2026-08-13) names it CURRENT/GOVERNING. Its object-level/meta-level distinction and "notice before explain" instinct are compatible with today's correction; its ten-stage arc carries the same "fixed sequence, not adjustable by book" assumption as the two documents above. This map does not mark it superseded — that is Susan's call on her own document, not mine to declare by editing a map entry.
...
Surveys established, professionally grounded facilitation methods — Visual Thinking Strategies, Transformative Language Arts, Progoff's Intensive Journal Method, Kolb's Experiential Learning Cycle, IFBPT/CAPF poetry-facilitation credentialing (the clinical/nonclinical line), Pennebaker's expressive-writing research, and Jungian amplification as a live facilitation discipline, not only a research method. Not Dragon-specific — written for use across Figures. Maps each method against Dragon's existing stage architecture (Encounter through Return) as a table of resonances, not validation — **corrected in place, 2026-08-20**, after the Kolb section was first drafted as though the match between Kolb's cycle and Dragon's stages validated the architecture; see the Figure Research and Development Standard's same-day amendment on why a general framework may illuminate a Figure's revealed movement but never governs it. Does not itself authorize any script or material revision — that follows only after Steps 3–4 of the Figure Research and Development Standard.

**`AwakenArts_Participant_Value_Audit_Findings.docx`** — *Completed audit, undated header (repository file timestamp 2026-08-19).* **Flag, added 2026-08-20:** this document audits site pages against something it calls "the AwakenArts Participant-Value Standard" (cited by section number — Section 2, 4 "Poem-to-Experience Development Standard," 5 "Prompt Standard," 6, 8, 10) — but that Standard could not be located as a standalone file anywhere in this repository under that name or a close variant, and is not listed anywhere in this map prior to this entry. A broader search of `/Users/sashe/Documents/Claude/Projects` timed out due to folder size and was not completed. Susan's 2026-08-20 directive asked for a Path-crossing test to be added to this Standard directly; that could not be done without first locating or reconstructing it — **flagged for Susan rather than guessed at.** The Findings document itself remains a real, useful audit (KEEP/STRENGTHEN/REPOSITION/CONNECT/REWRITE/REMOVE findings for every major page, most notably that the Dragon Reader is the site's strongest content and is currently unlinked from anywhere) and is registered here for the first time.
