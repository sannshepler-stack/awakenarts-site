    ...
    <>
      ...
      <section className="hero" aria-label="Hero">
        ...
        <div className="hero__text">
          ...
          <p className="hero-subline">Works made of image and language, shaped to stay with you.</p>
      ...
      <section className="hero-quote-section" aria-label="Opening statement">
        <p className="hero-quote-text">
          Some things are easier to recognize in an image than to say with words alone.
        </p>
      </section>
